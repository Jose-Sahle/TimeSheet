...
namespace SHL.Criptografia
{
    public static class Cryptography
    {
        ...
        public static string Encryption(string Texto, String Chave)
        {
            ...
            CryptoStream cripto = new CryptoStream(mStream, rijndael.CreateEncryptor(bChave, bIV), CryptoStreamMode.Write);
        ...
        public static string Decryption(string Texto, String Chave)
        {
            ...
            try
            {
                ...
                CryptoStream decripto = new CryptoStream(mStream, rijndael.CreateDecryptor(bChave, bIV), CryptoStreamMode.Write);
