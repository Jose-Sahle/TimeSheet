...
namespace SHL.Base.Base
{
    public static class SQLHelper
    {
        ...
        public static String GetConnectionString()
        {
            ...
            {
                connectionstring = reponse.HttpResponseMessage.Content.ReadAsStringAsync().Result.ToString();
            ...
            connectionstring = SHL.Criptografia.Cryptography.Decryption(connectionstring);
        ...
        public static Int64 ExecuteNonQuery(String commandText, ArrayList parameters, SqlConnection connection, String ReturnParameter)
        {
            ...
            SqlParameter retVal = command.Parameters.Add(ReturnParameter, SqlDbType.Int);
